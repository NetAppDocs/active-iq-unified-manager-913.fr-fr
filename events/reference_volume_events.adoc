...
| Nom de l'événement (nom de l'argument) | Niveau d'impact | Type de source | Gravité 
 ...
 a| 
La surveillance des volumes anti-ransomware est activée (mode actif)
(Anti-ransomware VolumeStateEnabled)
 a| 
Événement
 a| 
Volumétrie
...
Informations
 ...
 a| 
La surveillance des volumes anti-ransomware est désactivée
(Anti-ransomware VolumeStateDisabled)
 a| 
Risques
 a| 
Volumétrie
...
Avertissement
 ...
 a| 
La surveillance des volumes anti-ransomware est activée (mode apprentissage)
(AntiransVolumeStateDryrun)
 a| 
Événement
 a| 
Volumétrie
...
Informations
 ...
 a| 
La surveillance des volumes anti-ransomware est interrompue (mode d'apprentissage)
(Anti-rankwareVolumeStateDryrunPaused)
 a| 
Risques
 a| 
Volumétrie
...
Avertissement
 ...
 a| 
Surveillance des volumes anti-ransomware interrompue (mode actif)
(Anti-ransomware VolumeStateEnablePaused)
 a| 
Risques
 a| 
Volumétrie
...
Avertissement
 ...
 a| 
La surveillance des volumes contre les ransomware est désactivée
(AntiRansomswareVolumeStateDisableInProgress)
 a| 
Risques
 a| 
Volumétrie
...
Avertissement
 ...
 a| 
Activité des ransomwares observée
(CallAccueilAccueilAccueilActivitéSeen)
 a| 
Gestion des
 a| 
Volumétrie
