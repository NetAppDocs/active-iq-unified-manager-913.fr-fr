...
* *Statut*
+
Affiche le statut actuel de l'agrégat membre. Le statut peut être critique (image:../media/sev_critical_um60.png[""]), erreur (image:../media/sev_error_um60.png[""]), Avertissement (image:../media/sev_warning_um60.png[""]) Ou Normal (image:../media/sev_normal_um60.png[""]).
...
** RAID mixte : l'agrégat contient des groupes RAID de différents types (RAID0, RAID4, RAID-DP et RAID-TEC).
Par défaut, cette colonne est masquée.
